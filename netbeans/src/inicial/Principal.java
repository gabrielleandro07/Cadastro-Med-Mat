...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        material.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/application_add.png"))); // NOI18N
        ...
        medicamento.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/application_add.png"))); // NOI18N
    ...
    private void materialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialActionPerformed
        // TODO add your handling code here:
        try {
            new gui.Cad_Mat().setVisible(true);
        } catch (Exception ex) {
            Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
        }
